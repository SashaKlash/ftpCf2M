<div class="hero-image">
    ...
    <section id="presentation">
        <p>Persévérant, observateur, débrouillard</p>
        <p>J'ai été serveur pendant presque quinze ans. J'ai adoré mon métier bien que souvent je n'avais pas l'opportunité de mettre en pratique des solutions aux problèmes que je rencontrais dans ce secteur.<br>Récemment, la crise du covid eu un terrible impact sur ma carrière puisque les établissements de restauration ont dû fermer, ce qui m'a laissé sans emploi. Mon métier était non essentiel pour l'heure.<br>
