...
<main class="liens">
    ...
    <section class="HTML">
        <h3>Tips HTML</h3>
            <p>Voici une liste des différents événements possible : <a href="https://www.w3schools.com/tags/ref_eventattributes.asp" target="_blank">W3C</a></p>
            <p>Liste des différents attributs et leur(s) tag(s) associés <a href="https://www.w3schools.com/tags/ref_attributes.asp" target="_blank">Ici</p>
    </section>
